...
<?php 
   ...
   <div id="profile"style = "height: 180px;">
	  ...
	  <div class = "userButtons"style = "height: 70px; width: 750px;background-color: coral;border-radius: 25px;margin: auto;z-index: 1;">
...
<div class = "userButtons"style = "height: 70px; width: 500px;color: #6699FF;text-align:center;font-size: 34px;font-weight: 500;margin: auto;">Website Data Management
	 ...
	 <div class = "userButtons"style = "height: 70px; width: 600px;background-color: coral;border-radius: 25px;margin: auto;z-index: 1; float:left;">
...
<div class = "userButtons"style = "height: 70px; width: 425px;color: #6699FF;text-align:center;font-size: 34px;font-weight: 500;margin: auto;">User Management
	  ...
	  <div class = "userButtons"style = "height: 70px; width: 560px;background-color: coral;border-radius: 25px;margin: auto;z-index: 1;">
	  ...
	  <button class="button" id="deleteData"style="margin-top:+15px;margin-left: 20px;margin-right: 20px;"><a href="cameraDataViewTransferred.php">See Transferred Data</a></button>
   	...
   	<div class = "userButtons"style = "height: 70px; width: 700px;color: #6699FF;text-align:center;font-size: 34px;font-weight: 500;margin: auto;">Camera Data Management
   	</div>
