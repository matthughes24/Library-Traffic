...
$userselect= $_SESSION['login_user'];
          $minnumquery = "SELECT MIN(NULLIF(PeopleEntered,0)) FROM traffic_daily AS MIN_PRICE "; 
          $result = mysqli_query($conn,$minnumquery);
            while($row = mysqli_fetch_array($result)){
                $minnum = $row['PeopleEntered'];
            }
?>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <ul class="navbar-nav ml-auto">
        ...
        <?php
          ...
          <a class="nav-link" href="importExcelDailyExit.php">Upload Excel File</a>
          </li>';
          if($num == 2)
          {
            echo $output;
  ...
  <h1 id="welcome" style="text-align:center; font-family:Roboto; color:#2f90ff;">New Paltz Library Traffic Camera<i></i></h1>
    ...
    <script type="text/javascript">
      ...
      function drawStuff() {
        ...
        var options = {
          chart: {
            title: 'Daily Exited Traffic Report',
            subtitle: 'Students exited from library',
          },
...
<script type="text/javascript">
	...
	<?php 
	  ...
	  ?>
        ...
        var options = {
          title: 'Daily Libary People Exited Count',
          curveType: 'none',
    ...
    <nav>
      <ul id="mainMenu">
        <li><a href="graphDailyReport.php">Entered</a></li>
        <li><a href="graphDailyReportExit.php">Exited</a></li>
        <li><a href="graphDailyReportDual.php">Enter/Exited</a></li>
      </ul>
    </nav>
