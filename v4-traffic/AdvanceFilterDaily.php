...
include('config.php');
 ...
 //filter.php  
 if(isset($_POST["Date"],$_POST["to_time"], $_POST["from_time"] ) || 1 == 1)  
 {  
    ...
    $trueDate  = date("Y-m-d", strtotime($date) );
      $output = '';
       $query = "SELECT * FROM traffic_Cam_Data WHERE dateStart='".$trueDate . "' AND timeStart BETWEEN '".$_POST["from_time"] . "' AND '". $_POST["to_time"] . "' ORDER BY timeStart"; //Query of a specified date between two times
      $result = mysqli_query($conn, $query);  //grab that result
      ...
      ';  
      if(mysqli_num_rows($result) > 0)  //display the data of the query for a specified date between two times
      {  
...
<script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"></script>
      ...
      function drawStuff() {
        var data = new google.visualization.arrayToDataTable([
          ...
          <?php 
          $query = "SELECT * FROM traffic_Cam_Data WHERE dateStart='".$trueDate . "' AND timeStart BETWEEN '".$_POST["from_time"] . "' AND '". $_POST["to_time"] . "' ORDER BY timeStart";
