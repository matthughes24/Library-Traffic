...
<head> 
  ...
  <title>Advanced Daily Traffic Log</title>
...
<body>
     ...
     ?>
  	<div class="container" style="width:900px;">  
               <h2 style="text-align: center;">Advanced Daily Report</h2>  
     ...
     $(document).ready(function(){  
          ...
          $('#filtertime').click(function(){  
               ...
               {  
                    ...
                    $.ajax({  
                         url:"AdvanceFilterDaily.php",  
                         method:"POST",   
                         data:{from_time:from_time, to_time:to_time, Date:Date},  
