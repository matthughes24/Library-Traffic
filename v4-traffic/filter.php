...
include('config.php');
 ...
 {  
      $conn = $link;
      $output = '';  
      $query = "SELECT * FROM traffic_monthly INNER JOIN traffic_monthly_exited ON traffic_monthly.DayOfMonth=traffic_monthly_exited.DayOfMonth WHERE traffic_monthly.DayOfMonth BETWEEN '".$_POST["from_date"]."' AND '".$_POST["to_date"]."'";  
    ...
    <script type="text/javascript">
      ...
      function drawStuff() {
        var data = new google.visualization.arrayToDataTable([
          ...
          <?php 
            $sql = "SELECT * FROM traffic_monthly INNER JOIN traffic_monthly_exited ON traffic_monthly.DayOfMonth=traffic_monthly_exited.DayOfMonth WHERE MonthlyRepmonthly_report_dataortData.DayOfMonth BETWEEN '".$_POST["from_date"]."' AND '".$_POST["to_date"]."'";
