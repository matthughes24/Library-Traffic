...
<title>Transfer Camera Data</title>
...
<p> <h2> TRANSFER Data from CAMERA to DATABASE</h2> </p>
<p> <h3> (HOURLY for one DAY at a time) </h3> </p>
...
$datarowJSON = rtrim($datarowJSON, ",\r\n"); 
	...
	//Insert into traffic_Cam_Data
	$conn = mysqli_connect("localhost","p_s23_02","rbwcx7","p_s23_02_db");
