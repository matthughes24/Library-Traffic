...
<HTML>
  ...
  <BODY>
	<h1>Warning! Deleting Annual Report data will mean a complete memory wipe!</h1>
	<h2>You will have to upload reports manually or through excel import after this process is completed</h2>
        <form action="" method="post">
	  <h3>Are you sure you want to delete all report data?</h3>
