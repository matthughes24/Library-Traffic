...
while x < 5:
    ...
    while y < 8:
        ...
        f.write("<html>"+"\n")
        f.write("<body>"+"\n"+"\n")
        f.write('<img src=	"http://a.cs.newpaltz.edu/vlib/idata/amit/c01/A/c01A_s'+str(x)+'_L'+str(y)+'-1.jpg" alt=	"Shelf Left" width=	"460" height=	"345">'+"\n"+"\n")
        f.write('<img src=	"http://a.cs.newpaltz.edu/vlib/idata/amit/c01/A/c01A_s'+str(x)+'_L'+str(y)+'-2.jpg" alt=	"Shelf Middle" width=	"460" height=	"345">'+"\n"+"\n")
        f.write('<img src=	"http://a.cs.newpaltz.edu/vlib/idata/amit/c01/A/c01A_s'+str(x)+'_L'+str(y)+'-3.jpg" alt=	"Shelf Right" width=	"460" height=	"345"><br>'+"\n"+"\n")
