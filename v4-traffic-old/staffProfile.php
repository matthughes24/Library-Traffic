...
<?php 
   ...
   <h1 id="welcome">STAFF DASHBOARD</h1>
      <h2>Welcome back, Staff</h2>
      <br>
	  
			<div class = "userButtons"style = "height: 70px; width: 400px;background-color: coral;border-radius: 25px;margin: auto;z-index: 1; float:center;">
	  ...
	  <br>
	  <br>
	  <div class = "userButtons"style = "height: 70px; width: 890px;background-color: coral;border-radius: 25px;margin: auto;z-index: 1;float:center;">
      ...
      <button class="button" id="addAdmin" style="margin-top:+15px;margin-left: 20px;margin-right: 20px;"><a href="trafficLogDaily.php">View Traffic Data</a></button>
      <button class="button" id="changePassword"style="margin-top:+15px;margin-left: 20px;margin-right: 20px;"><a href="importExcelMakeAChoice.php">Upload To Database</a></button>
	  <button class="button" id="changePassword"style="margin-top:+15px;margin-left: 20px;margin-right: 20px;"><a href="DataMakeAChoice.php">Download from Database</a></button>
	  <button class="button" id="changePassword"style="margin-top:+15px;margin-left: 20px;margin-right: 20px;"><a href="warningDeleteData.php">Delete Traffic Data</a></button>
	  <div class = "userButtons"style = "height: 70px; width: 400px;background-color: coral;border-radius: 25px;">
			</div>
			<div class = "userButtons"style = "height: 70px; width: 425px;color: #6699FF;text-align:center;font-size: 34px;font-weight: 500;margin: auto;">Data Management
			</div>
	  </div>
