    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <ul class="navbar-nav ml-auto">
        ...
        <?php
          ...
          <a class="nav-link" href="importExcelMonthly.php">Upload Excel File</a>
          </li>';
          if($num == 2)
          {
            echo $output;
      ...
      function drawChart() {
        ...
        var options = {
          chart: {
            ...
            subtitle: 'Day of the Month Entered and People Entered',
            width: '3000',
            height: 300,
          },
...
<script type="text/javascript">
      ...
      function drawChart() {
        ...
        var options = {
          title: 'Monthly Libary People Entered Count',
          curveType: 'none',
