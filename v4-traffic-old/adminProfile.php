...
<?php 
   ...
   <div class = "userButtons"style = "height: 70px; width: 600px;background-color: coral;border-radius: 25px;margin: auto;z-index: 1;">
	  ...
	  <button class="button" id="deleteData"style="margin-top:+15px;margin-left: 20px;margin-right: 20px;"><a href="cameraDataTransfer.php">Transfer Camera DATA</a></button>
	  <button class="button" id="deleteData"style="margin-top:+15px;margin-left: 20px;margin-right: 20px;"><a href="cameraDataViewTransferred.php">See Transferred DATA</a></button>
   </div>
   <div class = "userButtons"style = "height: 70px; width: 500px;color: #6699FF;text-align:center;font-size: 34px;font-weight: 500;margin: auto;">CAMERA Data Management
   </div>

   <div class = "userButtons"style = "height: 70px; width: 900px;background-color: coral;border-radius: 25px;margin: auto;z-index: 1;">
     <button class="button" id="deleteData"style="margin-top:+15px;margin-left: 20px;margin-right: 20px;"><a href="cameraDataViewTransferred.php">See Transferred DATA</a></button>
   ...
   <div class = "userButtons"style = "height: 70px; width: 500px;color: #6699FF;text-align:center;font-size: 34px;font-weight: 500;margin: auto;">WEBSITE Data Management
   </div>


   <div class = "userButtons"style = "height: 70px; width: 170px;background-color: coral;border-radius: 25px;margin: auto;z-index: 1;">
	  <button class="button" id="deleteData"style="margin-top:+15px;margin-left: 20px;margin-right: 20px;"><a href="viewMockData.php">View MOCK DATA</a></button>
   </div>
   <div class = "userButtons"style = "height: 70px; width: 500px;color: #6699FF;text-align:center;font-size: 34px;font-weight: 500;margin: auto;">MOCK Data Management
   </div>
