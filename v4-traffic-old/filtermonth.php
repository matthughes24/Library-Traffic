...
include('config.php');
 ...
 {  
      ...
      $conn = $link;
      $output = ''; 
      $query = "SELECT * FROM traffic_annual INNER JOIN AnnualReportDataExited ON traffic_annual.Month=AnnualReportDataExited.Month WHERE traffic_annual.ID BETWEEN '".$_POST["from_month"]."' AND '".$_POST["to_month"]."'";  
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0-beta/js/bootstrap.min.js" integrity="sha384-h0AbiXch4ZDo7tp9hKZ4TsHbi047NrKGLO3SEJAg45jXxnGIfYzk4Si90RDIqNm1" crossorigin="anonymous"></script>
      ...
      function drawStuff() {
        var data = new google.visualization.arrayToDataTable([
          ...
          <?php 
          $sql = "SELECT * FROM traffic_annual INNER JOIN AnnualReportDataExited ON traffic_annual.Month=AnnualReportDataExited.Month WHERE traffic_annual.ID BETWEEN '".$_POST["from_month"]."' AND '".$_POST["to_month"]."'";  
