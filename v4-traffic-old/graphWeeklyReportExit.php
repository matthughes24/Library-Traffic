    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <ul class="navbar-nav ml-auto">
        ...
        <?php
          ...
          <a class="nav-link" href="importExcelWeeklyExit.php">Upload Excel File</a>
          </li>';
          if($num == 2)
          {
            echo $output;
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ['Day of the Week', 'People Exited'],
          <?php
           $max = 0;
           $min = 12;
           $maxtime = '';
           $mintime = '';
            $sql = "SELECT * FROM traffic_weekly_exited";
            $result = mysqli_query($conn,$sql);
            while($row = mysqli_fetch_array($result)){
                    echo "['".$row['DayOfWeek']."',".$row['PeopleExited']."],";
        ...
        var options = {
          chart: {
            title: 'Weekly Traffic Exited Report Data',
            subtitle: 'Day of Week Exited and People Exited',
            width: '3000',
            height: 300,
          },
...
<script type="text/javascript">
	...
	<?php 
	  ...
	  ?>
        ...
        var options = {
          title: 'Weekly Libary People Exited Count',
          curveType: 'none',
