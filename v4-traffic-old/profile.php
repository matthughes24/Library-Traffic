<?php
$myfile = fopen("uploads/s1-camera.txt", "w") or die("Unable to open file1!");
$txt = "1";
fwrite($myfile, $txt);
fclose($myfile);
error_reporting(0);
...
<?php 
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav ml-auto">
				...
				if ($num == 1) {
					...
					echo '<li class="nav-item"><a class="nav-link" href="loginPage.php">Admin Login<span class="sr-only"></span></a></li>';
				}
				?>
			</ul>
		</div>
   ...
   <div id="profile"style = "height: 260px;">
      <h1 id="welcome">GUEST DASHBOARD</h1>
      <h2>Welcome!</h2>
	  <br>
	  <div class = "userButtons"style = "height: 70px; width: 500px;background-color: coral;border-radius: 25px;margin: auto;z-index: 1;">
      <button class="button" id="showLogs" style="margin-top:+15px;margin-left: 20px;margin-right: 20px;"><a href="trafficLogDaily.php">View Data</a></button>
	  ...
	  <div class = "userButtons"style = "height: 70px; width: 500px;background-color: coral;border-radius: 25px;z-index: -1;">
			</div>
	  </div>
	  <div class = "userButtons"style = "height: 70px; width: 500px;color: #6699FF;text-align:center;font-size: 34px;font-weight: 500;margin: auto;">Analytics
			</div>
   </div>
   <br>
