    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <ul class="navbar-nav ml-auto">
        ...
        <?php
          ...
          <a class="nav-link" href="importExcelAnnualExit.php">Upload Excel File</a>
          </li>';
          if($num == 2)
          {
            echo $output;
...
<h1 id="welcome" style="text-align:center; font-family:Roboto; color:#2f90ff;">New Paltz Library Traffic Camera<i></i></h1>
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ...
          <?php
            ...
            while($row = mysqli_fetch_array($result)){
                    echo "['".$row['Month']."',".$row['PeopleExited']."],";
        ...
        var options = {
          chart: {
            title: 'Annual Traffic Report Data',
            subtitle: 'Month Exited and People Exited',
            width: '3000',
            height: 300,
          },
